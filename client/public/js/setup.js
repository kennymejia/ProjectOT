...
function insertData(data) {
    document.getElementById('member0').innerHTML = "Member 0: " + data.players[0].name;
    ...
    document.getElementById('profession').innerHTML = "Profession: " + data.profession.job;
    document.getElementById('money').innerHTML = "Starting Money: " + data.profession.money;
